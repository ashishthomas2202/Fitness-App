...
export default function AccessibilityBar() {
  ...
  useEffect(() => {
    ...
    const savedVisibility = localStorage.getItem('accessibility-button-visible');
  ...
  const toggleButtonVisibility = () => {
    ...
    localStorage.setItem('accessibility-button-visible', newVisibility.toString());
    if (!newVisibility) {
      setIsOpen(false);
    }
  };
            ...
            >
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium dark:text-gray-200">Font Size</span>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium dark:text-gray-200">Text Highlighter</span>
                    <button
                ...
                {/* High Contrast */}
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium dark:text-gray-200">High Contrast</span>
                  <button
                ...
                {/* Hide Button Option */}
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium dark:text-gray-200">Show Button</span>
                  <button
                    onClick={toggleButtonVisibility}
                    className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-800 transition-colors text-gray-700 dark:text-gray-200"
