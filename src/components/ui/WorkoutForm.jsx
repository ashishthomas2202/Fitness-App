          ...
          <div className="flex gap-4">
            <label>
              <input
                type="checkbox"
                value="Strength"
                checked={getValues("type").includes("Strength")}
            ...
            <label>
              <input
                type="checkbox"
                value="Cardio"
                checked={getValues("type").includes("Cardio")}
                onChange={(e) => onCheckboxChange(e, "type")}
              />
              Cardio
            </label>
            <label>
              <input
                type="checkbox"
                value="Flexibility"
                checked={getValues("type").includes("Flexibility")}
                onChange={(e) => onCheckboxChange(e, "type")}
              />
              Flexibility
            </label>
          ...
          <div className="flex gap-4">
            <label>
              <input
                ...
                checked={getValues("category").includes("Weight Training")}
            ...
            <label>
              <input
                type="checkbox"
                value="Calisthenics"
                checked={getValues("category").includes("Calisthenics")}
                onChange={(e) => onCheckboxChange(e, "category")}
              />
              Calisthenics
            </label>
          ...
          <div className="flex gap-4">
            <label>
              <input
                type="checkbox"
                value="Chest"
                checked={getValues("muscle_groups").includes("Chest")}
            ...
            <label>
              <input
                type="checkbox"
                value="Legs"
                checked={getValues("muscle_groups").includes("Legs")}
                onChange={(e) => onCheckboxChange(e, "muscle_groups")}
              />
              Legs
            </label>
            <label>
              <input
                type="checkbox"
                value="Arms"
                checked={getValues("muscle_groups").includes("Arms")}
                onChange={(e) => onCheckboxChange(e, "muscle_groups")}
              />
              Arms
            </label>
          ...
          <div className="flex gap-4">
            <label>
              <input
                type="checkbox"
                value="Dumbbells"
                checked={getValues("equipment").includes("Dumbbells")}
            ...
            <label>
              <input
                type="checkbox"
                value="Barbell"
                checked={getValues("equipment").includes("Barbell")}
                onChange={(e) => onCheckboxChange(e, "equipment")}
              />
              Barbell
            </label>
