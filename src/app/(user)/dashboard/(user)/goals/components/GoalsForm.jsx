...
const validationSchema = Yup.object().shape({
  ...
  weightGoal: Yup.number()
    ...
    .min(0, "Cannot be negative")
    .nullable(),
  stepsGoal: Yup.number()
    .typeError("Must be a number")
    .min(0, "Cannot be negative")
    .nullable(),
  flightsClimbedGoal: Yup.number()
    .typeError("Must be a number")
    .min(0, "Cannot be negative")
    .nullable(),
  distanceGoal: Yup.number()
    .typeError("Must be a number")
    .min(0, "Cannot be negative")
    .nullable(),
  waterIntakeGoal: Yup.number()
    .typeError("Must be a number")
    .min(0, "Cannot be negative")
    .nullable(),
  caloriesBurnedGoal: Yup.number()
    .typeError("Must be a number")
    .min(0, "Cannot be negative")
    .nullable(),
});
...
export default function GoalsForm({ onSave, currentGoals }) {
  ...
  return (
    <form
      ...
      className="space-y-4 bg-gray-50 dark:bg-neutral-900 p-6 rounded-lg shadow-md"
    >
      {/* Calorie Goal */}
      <div className="flex items-center space-x-3">
        ...
        <div className="w-full">
          ...
          />
          {errors.calorieGoal && (
            <p className="text-red-500 text-sm">{errors.calorieGoal.message}</p>
          )}
        </div>
      </div>
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="w-full">
          ...
          />
          {errors.weightGoal && (
            <p className="text-red-500 text-sm">{errors.weightGoal.message}</p>
          )}
        </div>
      </div>
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="w-full">
          ...
          />
          {errors.stepsGoal && (
            <p className="text-red-500 text-sm">{errors.stepsGoal.message}</p>
          )}
        </div>
      </div>
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="w-full">
          <Input
            type="number"
            {...register("flightsClimbedGoal")}
            className="bg-gray-100 w-full"
          />
          {errors.flightsClimbedGoal && (
            <p className="text-red-500 text-sm">
              {errors.flightsClimbedGoal.message}
            </p>
          )}
        </div>
      </div>
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="w-full">
          <Input
            type="number"
            {...register("waterIntakeGoal")}
            className="bg-gray-100 w-full"
          />
          {errors.waterIntakeGoal && (
            <p className="text-red-500 text-sm">
              {errors.waterIntakeGoal.message}
            </p>
          )}
        </div>
      </div>
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="w-full">
          <Input
            type="number"
            {...register("caloriesBurnedGoal")}
            className="bg-gray-100 w-full"
          />
          {errors.caloriesBurnedGoal && (
            <p className="text-red-500 text-sm">
              {errors.caloriesBurnedGoal.message}
            </p>
          )}
        </div>
      </div>
      ...
      <Button
        type="submit"
        className="mt-4 w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg py-2"
      >
        Save Goal
      </Button>
    </form>
